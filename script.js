...
.input-group .fa-dice:hover {
    color: var(--primary-color);
}

.input-group .fa-comment-dots {
    right: 1rem;
...
.close-modal, .close-camera-modal {
    position: absolute;
    top: 1rem;
    right: 1rem;
    font-size: 1.5rem;
...
.close-modal:hover, .close-camera-modal:hover {
    color: #00b386;
}
...
/* Tooltip de error para validación de passphrase */
#passphrase-error {
    position: absolute;
    top: 100%;
    left: 50%;
...
@keyframes pulseGlow {
    ...
    50% { text-shadow: 0 0 20px var(--glow-color), 0 0 30px rgba(0, 204, 153, 0.5); }
...
/* Asegurar que .hidden oculte correctamente */
.hidden {
